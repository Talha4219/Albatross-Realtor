...
import { ShieldCheck, Gavel, DatabaseZap, Share2, Clock, FileText, Mail } from 'lucide-react';
          ...
          <Accordion type="single" collapsible className="w-full mt-6">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-base">
                <h4 className="font-semibold mt-2">Interpretation</h4>
                <p>
                ...
                <h4 className="font-semibold mt-4">Definitions</h4>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    Albatross Realtor, 541 F, Block 'D', Wapda Town Islamabad.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to Albatross Realtor,
                    accessible from https://albatrossrealtor.com
                  </li>
                  <li>
            ...
            <AccordionItem value="item-2">
               <AccordionTrigger className="text-lg font-semibold hover:no-underline">
                <div className="flex items-center gap-2">
                    <DatabaseZap className="w-5 h-5 text-primary" /> Collecting and Using Your Personal Data
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base">
                 <h4 className="font-semibold mt-2">Types of Data Collected</h4>
                 <h5 className="font-medium mt-2">Personal Data</h5>
                 ...
                 <h5 className="font-medium mt-4">Usage Data</h5>
                 ...
                 <h5 className="font-medium mt-4">Tracking Technologies and Cookies</h5>
             ...
             <AccordionItem value="item-3">
               <AccordionTrigger className="text-lg font-semibold hover:no-underline">
                <div className="flex items-center gap-2">
                    <Share2 className="w-5 h-5 text-primary" /> Use and Sharing of Your Personal Data
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base">
                 <h4 className="font-semibold mt-2">Use of Your Personal Data</h4>
                 ...
                 <h4 className="font-semibold mt-4">We may share Your personal information in the following situations:</h4>
                 <ul className="list-disc pl-6 space-y-2">
            ...
            <AccordionItem value="item-4">
               <AccordionTrigger className="text-lg font-semibold hover:no-underline">
                <div className="flex items-center gap-2">
                    <Clock className="w-5 h-5 text-primary" /> Data Retention and Transfer
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base">
                 <h4 className="font-semibold mt-2">Retention of Your Personal Data</h4>
                 ...
                 <h4 className="font-semibold mt-4">Transfer of Your Personal Data</h4>
            ...
            <AccordionItem value="item-5">
               <AccordionTrigger className="text-lg font-semibold hover:no-underline">
                <div className="flex items-center gap-2">
                    <ShieldCheck className="w-5 h-5 text-primary" /> Your Data Rights and Security
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base">
                <h4 className="font-semibold mt-2">Delete Your Personal Data</h4>
                ...
                <h4 className="font-semibold mt-4">Security of Your Personal Data</h4>
            ...
            <AccordionItem value="item-6">
               <AccordionTrigger className="text-lg font-semibold hover:no-underline">
                <div className="flex items-center gap-2">
                    <FileText className="w-5 h-5 text-primary" /> Disclosure and Other Policies
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-base">
                <h4 className="font-semibold mt-2">Disclosure of Your Personal Data</h4>
                <h5 className="font-medium mt-2">Business Transactions</h5>
                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                <h5 className="font-medium mt-4">Law enforcement</h5>
                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                <h5 className="font-medium mt-4">Other legal requirements</h5>
                ...
                <h4 className="font-semibold mt-4">Children's Privacy</h4>
                ...
                <h4 className="font-semibold mt-4">Links to Other Websites</h4>
            ...
            <AccordionItem value="item-7">
              ...
              <AccordionContent className="text-base">
                <h4 className="font-semibold mt-2">Changes to this Privacy Policy</h4>
