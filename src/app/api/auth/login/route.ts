...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (!token) {
        console.error("Login API Error: JWT token generation resulted in a falsy value. Check JWT_SECRET and payload.", {userId: userObject.id, email: userObject.email, name: userObject.name});
