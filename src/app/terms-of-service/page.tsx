      ...
      <Card className="w-full max-w-2xl shadow-xl">
        ...
        <CardContent className="text-center prose dark:prose-invert max-w-none">
          <p className="text-muted-foreground mb-6">
            Our Terms of Service will be detailed here, covering user responsibilities, acceptable use, intellectual property, disclaimers, limitation of liability, and termination clauses.
          </p>
